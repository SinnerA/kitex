...
func newHTTP2Client(ctx context.Context, conn netpoll.Connection, opts ConnectOptions,
	...
	if opts.InitialConnWindowSize > 0 && opts.InitialConnWindowSize != defaultWindowSize {
	...
	if opts.InitialWindowSize > 0 && opts.InitialWindowSize != defaultWindowSize {
	...
	t.loopy = newLoopyWriter(clientSide, t.framer, t.controlBuf, t.bdpEst, t.initialWindowSize)
